...
const translations = {
  en: {
    ...
    sharedDataNotice: "Squads and the community feed are saved on this device only (this build has no shared backend yet).",
  },
  ar: {
    appName: "تحدي البيئة",
    ...
    sharedDataNotice: "المجموعات والمجتمع محفوظة على جهازك فقط (هذه النسخة لسه من غير سيرفر مشترك).",
  },
};
